...
// FIXED: Updated booking validation for dynamic time slots
const bookingValidation = [
  ...
  // FIXED: Custom validation for time logic with proper error handling
  body('endTime').custom((endTime, { req }) => {
    ...
    if (startTime && endTime) {
      try {
        ...
        if (startMinutes < 420 || endMinutes > 1080) { // 7 AM to 6 PM
